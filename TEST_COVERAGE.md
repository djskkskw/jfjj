...
> جمع‌بندی: **۲۹ فایل تست / ۱۰٬۱۷۹ خط / ۱۵۵۴+ سنجه**. همه در وضعیت فعلی **سبز**.
...
**آمار دقیق:** ۱۵ فایل کاملاً رفتاری (۰ تأیید متنی) + ۱۴ فایل ترکیبی (رفتاری + مجموعاً **۹۴** تأیید متنی).

---

## ۲. جدول کامل ۲۹ تست

### الف) کاملاً رفتاری — صفر تأیید متنی (۱۵ فایل)
