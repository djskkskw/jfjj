...
class Engine:
    ...
    def exchange_cmd(self, arg):
        ...
        if sub in ("msgok", "msgno", "msgclaimno", "msgwait", "msgnolink",
            ...
            when = {"msgok": "عضو بود و جوین شدم",
                    "msgno": "عضو نبود (یا نیامده یا جوین شده بود و لفت داده) — جوین نمی‌شوم",
                    "msgclaimno": "ادعا کرد جوین شده ولی اصلاً عضو نیست",
    ...
    def ex_msgs_text(self):
        ...
        sections = [
            ...
            ("❌ وقتی طرف عضو کانال نبود چه بگوید؟ — کسی که بود و بعد نبود\n"
             " (جوین شده بود و لفت داد) یا اصلاً عضو نشده",
             "تبادل پیام ناموفق اول عضو شو", "msg_no"),
            ("🗣 وقتی طرف ادعای جوین کرد ولی اصلاً عضو نبود چه بگوید؟",
