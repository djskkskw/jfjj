...
class Engine:
    ...
    def exchange_text(self):
        ...
        lines = [
            ...
            "",
            "🟢 وقتی می‌خواهی تبادل روشن یا خاموش شود:",
            "دستور آماده برای کپی:",
            "`تبادل روشن`",
            "`تبادل خاموش`",
            "",
            "🚶 وقتی می‌خواهی از گروه‌ها پیش‌قدم شوی:",
            "دستور آماده برای کپی:",
            "`تبادل پیش‌قدم`",
            "",
            "⚡ وقتی می‌خواهی همین حالا گروه‌ها اسکن شوند:",
            "دستور آماده برای کپی:",
            "`تبادل اسکن`",
            "",
            "🤖 وقتی می‌خواهی جوین خودکار یا تأیید دستی باشد:",
            "دستور آماده برای کپی:",
            "`تبادل خودکار`",
            "",
            "📋 وقتی می‌خواهی فهرست تبادل‌ها را ببینی:",
            "دستور آماده برای کپی:",
            "`تبادل فهرست`",
            "",
            "💬 وقتی می‌خواهی متن پیام‌های جوین را عوض کنی:",
            "دستور آماده برای کپی:",
            "`متن‌های تبادل`",
            "",
            "⚙️ وقتی می‌خواهی همه تنظیمات را ببینی و عوض کنی:",
            "دستور آماده برای کپی:",
            "`تبادل تنظیمات`",
            "",
            "📊 وقتی می‌خواهی گزارش تبادل را ببینی:",
            "دستور آماده برای کپی:",
            "`تبادل گزارش`",
            "",
            "↩️ بازگشت: `عادی`",
